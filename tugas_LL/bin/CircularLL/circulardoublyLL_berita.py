...
HEADER_LINES = 12
FOOTER_LINES = 17
#SCROLL_SPEED = 0.02   # kecepatan animasi huruf
...
class CircularDoublyLinkedList:
    ...
    def display_forward(self):
        ...
        while not stop_event.is_set():
            ...
            height = shutil.get_terminal_size().lines - 5 # kurangi margin atas

            total_lines = shutil.get_terminal_size().lines
            animation_height = total_lines - HEADER_LINES - FOOTER_LINES
            start_pos = HEADER_LINES + animation_height
            end_pos = HEADER_LINES
            ...
            for pos in range(start_pos, end_pos -1, -1):
                ...
                # cetak baris kosong sebelum teks
                for _ in range(pos):
                    print()
    ...
    def display_backward(self):
        ...
        while not stop_event.is_set():
            ...
            text = f"[{no}] {current.berita}"
            height = shutil.get_terminal_size().lines - 5
            total_lines = shutil.get_terminal_size().lines
            animation_height = total_lines - HEADER_LINES - FOOTER_LINES
            start_pos = HEADER_LINES + animation_height
            end_pos = HEADER_LINES

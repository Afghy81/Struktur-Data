...
class CircularDoublyLinkedList {
	...
	private static final int HEIGHT = 4; // lebar console (bisa disesuaikan)
	...
	public void scrollForward() {
        ...
        while (true) {
            ...
            for (int pos = HEIGHT; pos >= -1; pos--) {
                ...
                // Jika sudah di tengah → tahan 3 detik
                if (pos == HEIGHT / 2) {
                    try {
                        Thread.sleep(3000);
                    } catch (InterruptedException e) {
...
public class CircularDoublyLL_Berita {
